...
MonoBehaviour:
  ...
  m_LastLoadedLayoutName: mitch main 1
--- !u!114 &10
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_LastProjectPath: /Users/mitch/Dev/unity/mitch-unity/enviro-gaia-urp-test-2
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: 0c4d0000
    m_LastClickedID: 19724
    m_ExpandedIDs: 000000000c4d000000ca9a3b
    m_RenameOverlay:
...
MonoBehaviour:
  ...
  m_Position:
    ...
    speed: 2
    m_Value: {x: -112.13682, y: 36.652958, z: -27.698662}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Rotation:
    ...
    speed: 2
    m_Value: {x: -0.16849083, y: 0.38464645, z: -0.0716343, w: -0.9047259}
  m_Size:
    m_Target: 10
    speed: 2
    m_Value: 73.3003
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -589.25
    m_HBaseRangeMax: 589.25
    m_VBaseRangeMin: -331.5
    m_VBaseRangeMax: 331.5
    ...
    m_MinimalGUI: 1
  m_defaultScale: 2
  m_LastWindowPixelSize: {x: 4858, y: 2652}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
